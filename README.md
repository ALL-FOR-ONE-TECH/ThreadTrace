...
```powershell
irm "https://raw.githubusercontent.com/ALL-FOR-ONE-TECH/ThreadTrace/main/install.ps1?v=1.0.4" | iex
```

**Uninstall (One-Line Command):**
```powershell
irm "https://raw.githubusercontent.com/ALL-FOR-ONE-TECH/ThreadTrace/main/uninstall.ps1?v=1.0.4" | iex
```
